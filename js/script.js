//dados
let cidade = 'Londrina, PR';
let telefone = '+55 43 991963386';
let email = 'amandafrois@gmail.com'
...
let calculoIdade = getAge(new Date(1992, 8, 12));
console.log( getAge(new Date(1992, 8, 12)) );
